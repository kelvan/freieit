...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('freieit_expertprofile', (
            ...
            ('creator', self.gf('threaded_multihost.fields.CreatorField')(default=None, related_name='expertprofile_created', null=True, blank=True, to=orm['auth.User'])),
            ('editor', self.gf('threaded_multihost.fields.EditorField')(blank=True, related_name='expertprofile_last_modified', null=True, to=orm['auth.User'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True)),
            ('image', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
            ('services', self.gf('django.db.models.fields.CharField')(max_length=2048)),
            ...
            ('time', self.gf('django.db.models.fields.CharField')(max_length=1024)),
            ('charges', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('currency', self.gf('django.db.models.fields.CharField')(max_length=3, null=True, blank=True)),
            ('charges_details', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('freieit', ['ExpertProfile'])

        # Adding model 'Link'
        db.create_table('freieit_link', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('datetime_created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('datetime_modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('creator', self.gf('threaded_multihost.fields.CreatorField')(default=None, related_name='link_created', null=True, blank=True, to=orm['auth.User'])),
            ('editor', self.gf('threaded_multihost.fields.EditorField')(blank=True, related_name='link_last_modified', null=True, to=orm['auth.User'])),
            ('expert', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['freieit.ExpertProfile'])),
            ('label', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('url', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('freieit', ['Link'])


    def backwards(self, orm):
        # Deleting model 'ExpertProfile'
        db.delete_table('freieit_expertprofile')

        # Deleting model 'Link'
        db.delete_table('freieit_link')
