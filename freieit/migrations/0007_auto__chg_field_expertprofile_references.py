...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ExpertProfile.references'
        db.alter_column('freieit_expertprofile', 'references', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'ExpertProfile.references'
        db.alter_column('freieit_expertprofile', 'references', self.gf('django.db.models.fields.CharField')(max_length=512))
    ...
    models = {
        ...
        'freieit.expertprofile': {
            ...
            'references': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
