...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExpertProfile.description'
        db.add_column('freieit_expertprofile', 'description',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=2048, blank=True),
                      keep_default=False)

        # Adding field 'ExpertProfile.references'
        db.add_column('freieit_expertprofile', 'references',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=512, blank=True),
                      keep_default=False)

        # Adding field 'ExpertProfile.available'
        db.add_column('freieit_expertprofile', 'available',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


        # Changing field 'ExpertProfile.name'
        db.alter_column('freieit_expertprofile', 'name', self.gf('django.db.models.fields.CharField')(default='NONE', max_length=512))

        # Changing field 'ExpertProfile.charges'
        db.alter_column('freieit_expertprofile', 'charges', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2))
        ...
        # Changing field 'ExpertProfile.charges_details'
        db.alter_column('freieit_expertprofile', 'charges_details', self.gf('django.db.models.fields.CharField')(max_length=512))

        # Changing field 'ExpertProfile.currency'
        db.alter_column('freieit_expertprofile', 'currency', self.gf('django.db.models.fields.CharField')(max_length=3))

        # Changing field 'ExpertProfile.services'
        db.alter_column('freieit_expertprofile', 'services', self.gf('django.db.models.fields.CharField')(max_length=512))

    def backwards(self, orm):
        # Deleting field 'ExpertProfile.description'
        db.delete_column('freieit_expertprofile', 'description')

        # Deleting field 'ExpertProfile.references'
        db.delete_column('freieit_expertprofile', 'references')

        # Deleting field 'ExpertProfile.available'
        db.delete_column('freieit_expertprofile', 'available')


        # Changing field 'ExpertProfile.name'
        db.alter_column('freieit_expertprofile', 'name', self.gf('django.db.models.fields.CharField')(max_length=512, null=True))

        # Changing field 'ExpertProfile.charges'
        db.alter_column('freieit_expertprofile', 'charges', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'ExpertProfile.image'
        db.alter_column('freieit_expertprofile', 'image', self.gf('django.db.models.fields.files.ImageField')(default=None, max_length=100))

        # Changing field 'ExpertProfile.charges_details'
        db.alter_column('freieit_expertprofile', 'charges_details', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'ExpertProfile.currency'
        db.alter_column('freieit_expertprofile', 'currency', self.gf('django.db.models.fields.CharField')(max_length=3, null=True))

        # Changing field 'ExpertProfile.services'
        db.alter_column('freieit_expertprofile', 'services', self.gf('django.db.models.fields.CharField')(max_length=2048))
    ...
    models = {
        ...
        'freieit.expertprofile': {
            ...
            'charges': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '5', 'decimal_places': '2'}),
