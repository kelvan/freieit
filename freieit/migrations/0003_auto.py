...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field keywords on 'ExpertProfile'
        db.create_table('freieit_expertprofile_keywords', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('expertprofile', models.ForeignKey(orm['freieit.expertprofile'], null=False)),
            ('tag', models.ForeignKey(orm['freieit.tag'], null=False))
        ))
        db.create_unique('freieit_expertprofile_keywords', ['expertprofile_id', 'tag_id'])


    def backwards(self, orm):
        # Removing M2M table for field keywords on 'ExpertProfile'
        db.delete_table('freieit_expertprofile_keywords')
