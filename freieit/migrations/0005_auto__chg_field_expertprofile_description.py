...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ExpertProfile.description'
        db.alter_column('freieit_expertprofile', 'description', self.gf('django.db.models.fields.TextField')(max_length=2048))

    def backwards(self, orm):

        # Changing field 'ExpertProfile.description'
        db.alter_column('freieit_expertprofile', 'description', self.gf('django.db.models.fields.CharField')(max_length=2048))
